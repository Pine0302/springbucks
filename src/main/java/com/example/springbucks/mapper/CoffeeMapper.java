...
public interface CoffeeMapper {
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.example.springbucks.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.example.springbucks.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set name = #{name,jdbcType=VARCHAR},",
          "price = #{price,jdbcType=BIGINT,typeHandler=com.example.springbucks.handler.MoneyTypeHandler},",
